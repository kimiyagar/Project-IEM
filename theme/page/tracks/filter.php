<div class="col-md-12" id="tracks-filter">
    <h1>TRACKS</h1>
    <ul class="track_filter_list">
        ...
        <li>BPM
            <div class="sub_track_filter" style="width: 350px">
                <form action="" id="filter-tracks">
                    <input type="text" id="lowest" name="highest" placeholder="LOWEST" />
                    <span>TO</span>
                    <input type="text" id="lowest" name="highest" placeholder="HIGHEST" />
                    <br>
                    <input type="submit" value="APPLY" class="apply_btn">
                </form>
            </div>
        ...
        <li>GENRE
            <div id="genre" class="sub_track_filter">
                ...
                <ul style="margin-left: 0px">
                    ...
                    <li class="filter-genre-drop-list-item">
                        <input name="radioButton" value="" id="" data-type="genres" class="filter-drop-checkbox" type="checkbox">
                        <label for="fg-genre-" class="filter-drop-checkbox-label">
                            <span class="filter-item-count"></span>
                        </label>
                    </li>
                ...
                <ul style="margin-left: 0px">
                    <li class="filter-genre-drop-list-item">
                        ...
                        <label class="filter-drop-checkbox-label">
                            <span class="filter-item-count"><?php echo $vArtist->num ?></span>
                        </label>
                    </li>
                </ul>
            </div>
...
<div class="col-md-12 data-container">
    <div class="overlay" id="tracks-data" align="center">
        <img id="loading-image" src="../images/loaderr.gif"/>
    </div>
</div>